...
/**
 * DocladController implements the CRUD actions for Doclad model.
 */
class DocladController extends Controller
{
    ...
    /**
     * Displays a single Doclad model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing Doclad model.
    ...
    /**
     * Deletes an existing Doclad model.
